...
void setupLocator() {
  ...
  // Repayment Module
  locator.registerLazySingleton<RepaymentRepository>(() => RepaymentRepositoryImpl(locator<DioClient>()));
  locator.registerLazySingleton(() => RepaymentUseCase(locator<RepaymentRepository>()));
}
