...
class RepaymentRemoteDataSource {
  ...
  Future<List<RepaymentEntity>> getRepayments(int page, String query, String status) async {
    // Simulated API
    ...
    List<RepaymentEntity> repayments = data.map((e) => RepaymentEntity.fromJson(e)).toList();
    if (status != 'All') {
